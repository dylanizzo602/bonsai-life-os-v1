/* Habits page: Header, New Habit, single calendar table (target / minimum / none), add/edit modal */
...
/**
 * Habits section: calendar week (Sun–Sat) with prev/next arrows; desktop and mobile use the same week bounds.
 */
export function HabitsPage() {
  ...
  /* Sync visible range to the calendar week containing today (resize or day rollover) */
  useEffect(() => {
    if (isDesktop) {
      setWeekToToday()
    } else {
      setDateRange(calendarWeekRangeForToday)
    }
  }, [isDesktop, setWeekToToday, setDateRange, calendarWeekRangeForToday])
